...
[[nodiscard]] size_t vnode_effective_replication_map::get_replication_factor([[maybe_unused]] dht::token id, const seastar::sstring& datacenter) const {
    ...
    if (replication_strategy.get_type() == replication_strategy_type::network_topology) {
        ...
        size_t replication_factor = nrs->get_replication_factor(datacenter);
